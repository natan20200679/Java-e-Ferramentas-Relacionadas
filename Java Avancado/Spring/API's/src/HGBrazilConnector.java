...
public class HGBrazilConnector {
    ...
    /* Outra opção de acesso à uma API por este HOST...private static final String HOST = "34.117.10.255.nip.io" */
    private static final String URI = "weather";
    
    /* Outra opção de acesso à uma API por esta URI...private static final String URI = "previsoes" */
    ...
    public HGBrazilResponse fecthWeatherForCity (String city) {
        ...
        final ResponseEntity<HGBrazilResponse> responseEntity = this.restTemplate.exchange(uriComponentsBuilder.toUriString(), 
        HttpMethod.GET,entity, HGBrazilResponse.class);      
        HGBrazilResponse response = Optional.ofNullable(responseEntity.getBody()).orElse(null);

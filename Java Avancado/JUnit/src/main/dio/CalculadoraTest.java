 ...
 * 
 * Observem que não estamos nem perto de ter uma cobertura de testes adequada com estes exemplos abaixo. O nosso objetivo 
 * aqui é ilustrar a utilização do JUnit, e buscamos fazer os testes suficientes para isto.
 */
...
public class CalculadoraTest {
    ...
    @ParameterizedTest
    @CsvSource({ "1.0, 1.0, 2.0", "3.0, 3.0, 6.0" })

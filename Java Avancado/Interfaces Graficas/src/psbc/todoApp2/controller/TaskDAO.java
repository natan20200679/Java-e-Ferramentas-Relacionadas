...
package psbc.todoApp2.controller;
...
import psbc.todoApp2.util.ConnectionFactory;
...
public class TaskDAO {
    ...
    public void save(Task task) {
        ...
        String sql = "INSERT INTO tasks(idProject, name, description, status, notes, " + 
        "deadline, completed, createdAt, updatedAt) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public void update(Task task) {
        ...
        String sql = "UPDATE tasks SET idProject = ?, name = ?, description = ?, status = ?, " + 
        "notes = ?, deadline = ?, completed = ?, createdAt = ?, updatedAt = ? WHERE id = ?";
        Connection conn = null;
        PreparedStatement stmt = null;

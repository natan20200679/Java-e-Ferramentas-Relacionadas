 ...
 * exiba o valor do desconto e o valor a ser pago pelo cliente. O desconto deverá ser calculado sobre o valor do veículo
 * de acordo com o combustível (álcool – 25%, gasolina – 21% ou diesel – 14%). Com valor do veículo zero encerra entrada
...
public class E27 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\nBem-Vindo(a) ao CARANGO concessionária! Estamos concedendo descontos de acordo");
        System.out.println("com o tipo de combustível aceito pelo veículo. Para aproveitar, preencha as");
        ...
        while (true) {
            ...
            if (valor != 0) {
                ...
                switch (combustivel) {
                    ...
                    case "alcool":
                        System.out.printf("\nValor do Desconto: R$ %.2f", desconto_alcool);
                        System.out.printf("\nValor Total: R$ %.2f \n", valor_alcool);
                    ...
                    case "gasolina":
                        System.out.printf("\nValor do Desconto: R$ %.2f", desconto_gasolina);
                        System.out.printf("\nValor Total: R$ %.2f \n", valor_gasolina);
                    ...
                    case "diesel":
                        System.out.printf("\nValor do Desconto: R$ %.2f", desconto_diesel);
                        System.out.printf("\nValor Total: R$ %.2f \n", valor_diesel);

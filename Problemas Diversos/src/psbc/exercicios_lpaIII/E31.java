...
/*
 * Dados três valores A, B e C, em que A e B são números reais e C é um caractere, pede-se para imprimir o resultado da 
 * operação de A por B se C for um símbolo de operador aritmético; caso contrário deve ser impressa uma mensagem de 
...
public class E31 {
    ...
    public static void main(String[] args) {
        ...
        switch (C) {
            ...
            case '/':
                if (B == 0) {
                    throw new AssertionError("Divisão por zero -> Esta divisão tende ao infinito!");
                } else {
                    divisao = A / B;

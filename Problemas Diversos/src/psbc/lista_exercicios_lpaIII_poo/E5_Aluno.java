...
public class E5_Aluno {
    ...
    public String toString() {
        return "Aluno [matricula=" + matricula + ", media=" + media + ", mediaFinal=" + mediaFinal + ", nome="
                + nome + ", notaProva1=" + notaProva1 + ", notaProva2=" + notaProva2 + ", notaTrabalho="
                + notaTrabalho + ", provaFinal=" + provaFinal + "]";
    }
}

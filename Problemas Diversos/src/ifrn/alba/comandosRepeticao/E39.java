...
leia seu nome e seu tempo de serviço (em meses). Se o funcionário possuir mais de 12 meses na empresa, 
escreva a mensagem “tem direito a férias”. Caso contrário, escreva a mensagem “não tem direito a 
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < quant_func; i++) {
            ...
            if (meses > 12) {
                ...
                System.out.println("\n" + nome + ", com tempo de serviço de " + meses + " meses, " + ""

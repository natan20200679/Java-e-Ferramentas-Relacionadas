...
public class E4 {
    ...
    public static void main(String[] args) {
        ...
        /* 
        Ocorre o ítem c), pois a concatenação de variáveis do tipo char antes de string(aspas duplas) 
        corresponde à soma dos seus valores nativos hexadecimais, e após string corresponde à 

 ...
 * Variáveis primitivas são aquelas que foram criadas com a linguagem de programação e servem para 
 * armazenar valores simples, como por exemplo um número, um valor lógico ou até mesmo um caractere.
 * Já as variáveis não primitivas (referência) são aquelas que foram criadas com o aprimoramento da 
 * linguagem. Elas servem para armazenar valores mais complexos. Tipos, tamanhos e valores "default" 
 * das variáveis primitivas:
 * 
 ...
 * 
 * Note que nas variáveis primitivas o tipo inicia com uma letra minúscula, já nas variáveis não 
 * primitivas inicia com uma letra maiuscula
 * 
 * OPERADORES
 * 

/*
Dada uma lista encadeada individualmente e uma chave, conte o número de ocorrências da chave fornecida na 
lista encadeada. Por exemplo, se a lista encadeada fornecida for 1->2->1->2->1->3->1 e a chave fornecida 
for 1, a saída deverá ser 4.
 */

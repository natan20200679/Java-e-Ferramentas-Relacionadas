/*
Dada uma lista encadeada individualmente, temos que convertê-la em uma lista encadeada circular. Por exemplo, 
recebemos uma lista vinculada individualmente com quatro nós e queremos converter essa lista vinculada 
individualmente em uma lista vinculada circular.
 */
...
public class ListaEncadeada5 {
    ...
    static Node circular(Node head) {
        ...
        /* Checa isso enquanto head.next não é igual a null, então o topo aponta para o próximo nó */

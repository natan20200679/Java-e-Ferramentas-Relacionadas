/*
 * Escreva um algoritmo que solicite ao usuário a entrada de 4 notas. Para cada aluno, calcular a 
 * média dos alunos e exibir na tela. Ao final mostrar a média da turma. Ao lado da média do aluno 
 * deve seguir a seguinte regra de negócio:
 * 
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            for (int j = 0; j < 4; j++) {
                ...
                notas[i][j] = Float.parseFloat(JOptionPane.showInputDialog("Informe a nota nº " + (j + 1) + " de " + alunos[i]));

...
public class Hashmap_Linkedhashmap_Treemap_4 {
    
    public static void main(String[] args) {
        
        System.out.println("\n-- Crie um dicionário que relacione os estados e suas respectivas " + 
        "populações --");
        ...
        System.out.println("\n-- Confira se no estado da Paraíba (PB) com população 4.039.277 está no 
        dicionário,ncaso não, adicione --");

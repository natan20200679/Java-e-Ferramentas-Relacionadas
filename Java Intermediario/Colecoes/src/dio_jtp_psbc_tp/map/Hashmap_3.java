...
/*
Faça um programa que simule um lançamento de dados. Lance o dado 100 vezes e armazene. Depois, mostre quantas vezes cada
...
public class Hashmap_3 {
    ...
    private static Map<Integer, Integer> lancamentosOrganizados(List<Integer> lancamentosDeDados) {
        ...
        for (Integer resultadoDoLancamento : lancamentosDeDados) {
            ...
            // Se ao navegar na lista, o elemento armazenado na lista (que é o resultado do lançamento) já tiver
            // aparecido:

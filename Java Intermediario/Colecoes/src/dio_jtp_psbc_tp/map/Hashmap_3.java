...
/*
Faça um programa que simule um lançamento de dados. Lance o dado 100 vezes e armazene. Depois, mostre 
...
public class Hashmap_3 {
    ...
    public static void main(String[] args) {
        ...
        /* 
        Criação do dicionário de par de valores contendo a frequência de cada número do dado, através da 
        Chamada dométodo "lancamentosOrganizados", que se referencia ao resultado do método 
        "lancamentoDeDados" 
        */
        ...
        /*
        Chamada do método "exibindoResultadoDosLancamentosAgrupados", que se referencia ao resultado do 
        método "lancamentosOrganizadosPorGrupo" 
        */
    ...
    /*  
    Método que irá organizar os resultados dos lançamentos em grupos de 1 a 6 (resultados possíveis de um 
    dado), que se referencia à lista com os lançamentos do dado 
    */
    ...
    private static Map<Integer, Integer> lancamentosOrganizados(List<Integer> lancamentosDeDados) {
        ...
        Map<Integer, Integer> resultadoDosLancamentosOrganizados = new HashMap<>();
        ...
        for (Integer resultadoDoLancamento : lancamentosDeDados) {
            ...
            /* 
            Se ao navegar na lista, o elemento armazenado na lista (que é o resultado do lançamento) já 
            tiver aparecido: 
            */
            ...
            if (resultadoDosLancamentosOrganizados.containsKey(resultadoDoLancamento)) {
                ...
                /* 
                Pega esse resultado e coloca dentro do Map como key e informa, acrescentando +1 no value 
                para indicar que esse resultado apareceu mais uma vez. 
                */
                ...
                /* Se foi a primeira vez que o resultado apareceu na lista, Pega esse resultado e coloca 
                como key de um elemento do Map, e informa no valor que ele apareceu pela primeira vez, 
                indicando 1. 
                */
    ...
    resuldadoDosLancamentosAgrupados) {
        ...
        for (Map.Entry<Integer, Integer> entry : resuldadoDosLancamentosAgrupados.entrySet()) {
            ...
            /* 
            Formatando a saída no console com espaçamento. Pegando Key (Valor da face do dado) e Value 
            (quantas vezes deu o número dessa face nos lançamentos) 
            */

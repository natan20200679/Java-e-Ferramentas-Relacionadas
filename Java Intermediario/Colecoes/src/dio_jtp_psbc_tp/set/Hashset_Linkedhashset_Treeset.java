...
public class Hashset_Linkedhashset_Treeset {
    ...
    public static void main(String[] args) {
        ...
        // A solicitação referente à esta saída não poderá ser impressa porque Hashset não possui
        // métodos com índices
        System.out.println("\nExiba a posição da nota 5.0:");

        // A solicitação referente à esta saída não poderá ser impressa porque Hashset não possui
        // métodos com índices ("posição 4")
        System.out.println("\nAdicione na lista a nota 8.0 na posição 4:");

        // A solicitação referente à esta saída não poderá ser impressa porque Hashset não possui
        // métodos com índices (uso do Get para acesso ao elemento)

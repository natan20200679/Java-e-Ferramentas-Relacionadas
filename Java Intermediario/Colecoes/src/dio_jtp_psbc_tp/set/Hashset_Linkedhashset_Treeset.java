...
public class Hashset_Linkedhashset_Treeset {
    ...
    public static void main(String[] args) {
        ...
        /* 
        A solicitação referente à saída abaixo não poderá ser impressa porque Hashset não possui métodos 
        com índices 
        */
        ...
        /* 
        A solicitação referente à saída abaixo não poderá ser impressa porque Hashset não possui métodos com 
        índices ("posição 4") 
        */
        ...
        /* 
        A solicitação referente à saída abaixo não poderá ser impressa porque Hashset não possui métodos 
        com índices (uso do Get para acesso ao elemento) 
        */
        ...
        /* 
        A solicitação referente à saída abaixo não poderá ser impressa porque Hashset não possui
        métodos com índices 
        */
        ...
        /* 
        A solicitação referente à esta saída não poderá ser impressa porque Hashset não possui métodos 
        com índices 
        */

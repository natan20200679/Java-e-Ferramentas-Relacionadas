...
/**
 * Dadas as seguintes informações  de id e contato, crie um dicionário e ordene este dicionário
...
public class Ex_Dicionario_NomeId {
    ...
    public static void main(String[] args) {
        ...
        // Outro Método
        Set<Map.Entry<Integer, Contato>> set2 = new TreeSet<>
        ...
        Set<Map.Entry<Integer, Contato>> set3 = new TreeSet<>

...
public class Ex_NumerosAleatorios {
    ...
    public static void main(String[] args) {
        ...
        numerosAleatoriosInteger.stream().mapToInt(Integer::intValue).min()
                .ifPresent(System.out::println);

        System.out.print("\n-- Mostre o maior valor da lista --");
        numerosAleatoriosInteger.stream().mapToInt(Integer::intValue).max()
                .ifPresent(System.out::println);

        System.out.println("\n-- Pegue apenas os números ímpares e some --");
        int somaDosNumerosImPares = numerosAleatoriosInteger.stream().filter(i -> (i % 2 != 0))
                .mapToInt(Integer::intValue).sum();
        System.out.println(somaDosNumerosImPares);

        System.out.println("\n-- Mostre a lista na ordem númerica --");
        List<Integer> numerosOrdemNatural;
        numerosOrdemNatural = numerosAleatoriosInteger.stream()
...
//        Set<String> numerosAleatorios5Primeiros = numerosAleatorios.stream().limit(5)
//              .collect(Collectors.toSet());
//        System.out.println(numerosAleatorios5Primeiros); // Método mais tradicional

 ...
 * - Crie uma nova lista com os nomes Ismael e Rodrigo. Adicione todos os ítens da nova lista na 
 *   primeira criada (R)
...
public class Ex_Arraylist_Iterator_Set {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n-- Nova lista com os nomes Ismael e Rodrigo, Adicionamento destes ítens "
                + "na primeira" + " criada --");

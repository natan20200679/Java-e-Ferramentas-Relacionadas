...
public class Collect_Reduce_ForEach {
    ...
    public static void main(String[] args) {
        ...
        // Uso do Optional para evitar comparações com Null, já que será utilizado um método que 
        // requisita Comparator
        ...
        // Nesta implementação, o tipo booleano define o grupo dos pares como true, e o dos ímpares 
        // como false. Isto poderia ser invertido.
        Map<Boolean,List<Integer>> mapa = list2.stream().map(e -> e * 3)
                .collect(Collectors.groupingBy(e -> e % 2 == 0));
        System.out.println(mapa);

        System.out.println("\nAgrupamento dos Números pelo Resto da Divisão por 3:");
        Map<Integer,List<Integer>> mapa2 = list2.stream()
        ...
        String collect = list2.stream().map(e -> String.valueOf(e))
        ...
        // Nota: A Subtração, por não ser associativa, deve ser evitada, pois no uso do ParalellStream 
        // gerará erros no resultado final. O método reduce é usado em objetos imutáveis
        ...
        List<Integer> collect3 = list4.stream().filter(n -> n % 2 == 0)
                .collect(Collectors.toList());

...
public class DistanceService {
    ...
    public Double distanceUsingMath(final Long city1, final Long city2, final EarthRadius unit) {
        ...
        final Double[] location1 = StringLocationUtils.transform(cities.get(0)
                .getGeolocation());
        final Double[] location2 = StringLocationUtils.transform(cities.get(1)
                .getGeolocation());
    ...
    private double doCalculation(final double lat1, final double lon1, final double lat2, 
        ...
        double a = sin(lat / 2) * sin(lat / 2) + cos(toRadians(lat1)) * cos(toRadians(lat2)) 
                * sin(lon / 2) * sin(lon / 2);

...
public class Ex5 {
    ...
    public static void main(String[] args) {
        ...
        List<Integer> list3 = list2.stream().filter(e -> e % 2 == 0).map(e -> e * 3)
                .collect(Collectors.toList()); // Este método pode ser substúido por "toList()"
        ...
        // Nota: A Subtração, por não ser associativa, deve ser evitada, pois no uso do
        // ParalellStream gerará erros no resultado final. O método reduce é usado em objetos
        // imutáveis

...
public class Ex5 {
    ...
    public static void main(String[] args) {
        ...
        List<Integer> list3 = list2.stream().filter(e -> e % 2 == 0).map(e -> e * 3)

                /* Este método pode ser substúido por "toList()" */
        ...
        /*
        Nesta implementação, o tipo booleano define o grupo dos pares como true, e o dos ímpares como
        false. Isto poderia ser invertido.
         */
        ...
        /*
        Nota: A Subtração, por não ser associativa, deve ser evitada, pois no uso do ParalellStream gerará
        erros no resultado final. O método reduce é usado em objetos imutáveis
         */
        ...
        Double reduce2 = DoubleStream.of(1.5,2.9,6.7).reduce(Double.POSITIVE_INFINITY,
        ...
        Map<Boolean,List<Integer>> collect5 = list4.stream().collect(Collectors.partitioningBy((n) ->
                n % 3 == 0));
        ...
        Map<Integer,Double> collect6 = list4.stream().collect(Collectors.toMap(n -> n, n -> Math.pow
                (n.intValue(),5)));

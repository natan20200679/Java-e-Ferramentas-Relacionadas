...
/**
 * Exemplos das aulas de Rinaldo Júnior (Youtube), com pequenas modificações. Nota: Optional não 
 * deve ser usado para receber argumento, e apenas para retorno de método
 */
...
public class Ex {
    ...
    public static void main(String[] args) {
        ...
        // Mostra se conversão de s em número inteiro é sucesso, de acordo com as declarações a 
        // partir da linha 19
        System.out.println(numero.isPresent());

        System.out.println("----------");

        // Se a conversão for sucesso, a saída será o valor pós-conversão, e caso não for sucesso, a 
        // saída será um erro de exceção 
        System.out.println("----------");
        ...
        // declaração anterior, a declaração do Optional aqui gerará inconsistência. Então pode-se 
